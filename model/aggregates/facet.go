...
// sub-pipeline's <DefaultStage> to perform a multi-faceted aggregation: $bucket
...
// DefaultStage. If further aggregations are required, add additional stages after
